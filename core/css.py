...
def inject_css():
    ...
    .stHorizontalBlock:has([class*="st-key-topnav"]) button [data-testid="stMarkdownContainer"] {
      display: flex !important;
      flex-direction: column !important;
      align-items: center !important;
      justify-content: center !important;
    ...
    :root [data-testid="stSidebar"] .stButton > button,
    :root [data-testid="stSidebar"] .stButton > button[kind="primary"],
    :root [data-testid="stSidebar"] .stButton > button[kind="secondary"] {
    ...
    :root [data-testid="stSidebar"] .stButton > button p {
      line-height: 1 !important;
      margin: 0 !important;
    }
    :root [data-testid="stSidebar"] .st-key-sidebar_admin_btn {
      margin-top: 6px !important;
    }
    :root [data-testid="stSidebar"] .st-key-sidebar_divider {
      margin-top: -22px !important;
      padding: 0 !important;
    }
    :root [data-testid="stSidebar"] .st-key-sidebar_divider [data-testid="stElementContainer"] {
      margin: 0 !important;
      padding: 0 !important;
    }
    ...
    @media (max-width: 480px) {
      /* 기본: 모든 컬럼 1열 스택
         특이도 0,3,0 — 768px 규칙(0,3,0)과 동일, 나중 선언이므로 480px 규칙이 이김 */
      [data-testid="stHorizontalBlock"]:not(:has([class*="st-key-topnav"])) > [data-testid="stColumn"] {
      ...
      /* 네비게이션 바: 스택 해제 */
      [data-testid="stHorizontalBlock"]:has([class*="st-key-topnav"]) > [data-testid="stColumn"] {
        flex: 1 1 0 !important;
        min-width: 0 !important;
        max-width: none !important;
      }
      /* Zone 설정 행: 스택 해제 */
      [data-testid="stHorizontalBlock"]:has([class*="st-key-zone_row_"]) > [data-testid="stColumn"],
      [data-testid="stHorizontalBlock"]:has([class*="st-key-del_zone_"]) > [data-testid="stColumn"] {
        flex: 1 1 0 !important;
        min-width: 0 !important;
        max-width: none !important;
      }
...
/* 전일/익일 버튼 텍스트 한 줄 고정 */
    ...
    /* ── 계획 저장/예약 신청 버튼: 파란색 ── */
    :root .st-key-sched_submit_btn button,
    :root .st-key-sched_save_btn button {
      background-color: #2563eb !important;
      border-color: #1d4ed8 !important;
      color: #ffffff !important;
    }
    :root .st-key-sched_submit_btn button:hover,
    :root .st-key-sched_save_btn button:hover {
      background-color: #1d4ed8 !important;
      border-color: #1e40af !important;
    }
    :root .st-key-sched_submit_btn button p,
    :root .st-key-sched_save_btn button p {
      color: #ffffff !important;
    }
    ...
    .st-key-vehicle_count_wrap input {
      text-align: center !important;
    }
    ...
    /* ── "Press Enter to Submit Form" 툴팁 숨김 ── */
